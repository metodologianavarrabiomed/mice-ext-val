...
#' \item{\code{diabetes}}{if the patient is diagnosed with diabetes}
#' \item{\code{anychd}}{if the patient have suffered any CHD event during follow-up}
#' \item{\code{timechd}}{time of follow up of the patient}
#' }
#'
#' @docType data
#' @keywords dataset
