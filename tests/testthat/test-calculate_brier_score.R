...
testthat::test_that("the brier score is calculated properly for a cox model", {
  ...
  testthat::expect_no_error(calculate_brier_score(model = cox_model, data = data, type = "predictions_aggregated", n_boot = 10))
  cox_model <- calculate_brier_score(model = cox_model, data = data, type = "predictions_aggregated", n_boot = 10, seed = 123)
  testthat::expect_identical(
    round_to_precision(cox_model$brier_score),
...
testthat::test_that("the brier score is calculated properly for a cox model and recalibrated predictions", {
  ...
  testthat::expect_no_error(calculate_brier_score(model = cox_model, data = data, type = "predictions_recal_type_1", n_boot = 10))
  cox_model <- calculate_brier_score(model = cox_model, data = data, type = "predictions_recal_type_1", n_boot = 10, seed = 123)
  testthat::expect_identical(
    round_to_precision(cox_model$brier_score_type_1),
    round_to_precision(readRDS(test_path("fixtures", "cox", "brier_score_type_1_cox.rds")))
  )
  testthat::expect_no_error(calculate_brier_score(model = cox_model, data = data, type = "predictions_recal_type_2", n_boot = 10))
  cox_model <- calculate_brier_score(model = cox_model, data = data, type = "predictions_recal_type_2", n_boot = 10, seed = 123)
  testthat::expect_identical(
    round_to_precision(cox_model$brier_score_type_2),
...
testthat::test_that("the brier score is calculated properly for a logreg model with survival outcome", {
  ...
  testthat::expect_no_error(calculate_brier_score(model = logreg_model, data = data, type = "predictions_aggregated", n_boot = 10))
  logreg_model <- calculate_brier_score(model = logreg_model, data = data, type = "predictions_aggregated", n_boot = 10, seed = 123)
  testthat::expect_identical(
    round_to_precision(logreg_model$brier_score),
...
testthat::test_that("the brier score is calculated properly for a logreg model with survival outcome and recalibrated predictions", {
  ...
  testthat::expect_no_error(calculate_brier_score(model = logreg_model, data = data, type = "predictions_recal_type_1", n_boot = 10))
  logreg_model <- calculate_brier_score(model = logreg_model, data = data, type = "predictions_recal_type_1", n_boot = 10, seed = 123)
  testthat::expect_identical(
    round_to_precision(logreg_model$brier_score_type_1),
    round_to_precision(readRDS(test_path("fixtures", "logreg", "brier_score_type_1_logreg.rds")))
  )
  testthat::expect_no_error(calculate_brier_score(model = logreg_model, data = data, type = "predictions_recal_type_2", n_boot = 10))
  logreg_model <- calculate_brier_score(model = logreg_model, data = data, type = "predictions_recal_type_2", n_boot = 10, seed = 123)
  testthat::expect_identical(
    round_to_precision(logreg_model$brier_score_type_2),
