...
A generic method for calculating the type 2 recalibration predictions
for the given model.
...
A model with the variable `prediction_type_3` added to `predictions_agg`
and the recalibration parameters added to `recal_parameters`.
